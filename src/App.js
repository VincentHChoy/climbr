  ...
  return (
    <div className="h-screen bg-[#EEF3FC]">
      ...
      <a href="https://github.com/VincentHChoy/climbr" target='_blank'>
        <AiFillGithub size={50} className="text-secondary fixed top-0 right-0 opacity-80 cursor-pointer" />
      </a>

      <main className="flex flex-col items-center justify-center h-5/6">
        <img className="md:h-4/6 -my-10" src="mountain.png"/>
        <h1 className="font-comfortaa text-black md:text-9xl text-6xl font-bold">Climbr</h1>
        ...
        <AiFillDownCircle size={50} className="text-primary animate-bounce h-1/6 mx-auto" />
      <section className={`${sectionStyle}`}>
        <Fade left>
        <img className="rounded-2xl my-10" src="achivements.png"/>
        <h1 className="text-center text-4xl break-words">
          See all your sends and flashes for Squamish's top 100 boulders in one place
        </h1>
        </Fade>
      </section>
      <section className={`md:flex-row-reverse ${sectionStyle}`}>
        ...
        <h1 className="text-center text-4xl break-words mx-5">
            Filter, Search and log your <bold className="text-green-500">sends</bold>, <bold className="text-yellow-500">flashes</bold>, <bold className="text-orange-500">projects</bold>, and <bold className="text-primary">favorites</bold>
        </h1>
        </Fade>
      </section>
